    ...
    public function run(): void
    {
        $productId = [
            [
                ...
                'seasons' => ['秋', '冬'],
                'image_path' => 'storage/products/kiwi.png',
            ],
            [
                'name' => 'ストロベリー',
                'price' => 1200,
                ...
                'seasons' => ['春'],
                'image_path' => 'storage/products/strawberry.png',
            ],
            [
                'name' => 'オレンジ',
                'price' => 850,
                ...
                'seasons' => ['冬'],
                'image_path' => 'storage/products/orange.png',
            ],
            [
                'name' => 'スイカ',
                'price' => 700,
                ...
                'seasons' => ['夏'],
                'image_path' => 'storage/products/watermelon.png',
            ],
            [
                'name' => 'ピーチ',
                'price' => 1000,
                ...
                'seasons' => ['夏'],
                'image_path' => 'storage/products/peach.png',
            ],
            [
                'name' => 'シャインマスカット',
                'price' => 1400,
                ...
                'seasons' => ['夏', '秋'],
                'image_path' => 'storage/products/muscat.png',
            ],
            [
                'name' => 'パイナップル',
                'price' => 800,
                ...
                'seasons' => ['春', '夏'],
                'image_path' => 'storage/products/pineapple.png',
            ],
            [
                'name' => 'ブドウ',
                'price' => 1100,
                ...
                'seasons' => ['夏', '秋'],
                'image_path' => 'storage/products/grapes.png',
            ],
            [
                'name' => 'バナナ',
                'price' => 600,
                ...
                'seasons' => ['夏'],
                'image_path' => 'storage/products/banana.png',
            ],
            [
                'name' => 'メロン',
                'price' => 900,
                ...
                'seasons' => ['春', '夏'],
                'image_path' => 'storage/products/melon.png',
            ]
        ];
        ...
        foreach ($productId as $item) {
            ...
            $seasonIds = Season::whereIn('name', $item['seasons'])->pluck('id');
